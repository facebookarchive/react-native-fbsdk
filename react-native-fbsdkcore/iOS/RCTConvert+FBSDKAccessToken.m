...
+ (FBSDKAccessToken *)FBSDKAccessToken:(id)json
{
  ...
  if (data.count > 0) {
    return [[FBSDKAccessToken alloc]
            initWithTokenString:[RCTConvert NSString:data[@"tokenString"]]
            ...
            appID:[RCTConvert NSString:data[@"appID"]]
            userID:[RCTConvert NSString:data[@"userID"]]
            expirationDate:[RCTConvert NSDate:data[@"_expirationDate"]]
            refreshDate:[RCTConvert NSDate:data[@"_refreshDate"]]];
  }
  return nil;
}
